...
public abstract class TibetanAntelopeModel extends ZawaBaseModel<TibetanAntelopeEntity> {
    ...
    public static class Adult extends TibetanAntelopeModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Chest = partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -4.0F, -2.5F, 5.0F, 8.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 10.8F, -6.1F, -0.08656833156470901F, 0.0F, 0.0F));
            PartDefinition ArmBaseLeft = Chest.addOrReplaceChild("ArmBaseLeft", CubeListBuilder.create().texOffs(22, 34).mirror(true).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(2.0F, 1.3F, -1.0F, 0.400378539728563F, 0.0F, 0.0F));

            PartDefinition UpperArmLeft = ArmBaseLeft.addOrReplaceChild("UpperArmLeft", CubeListBuilder.create().texOffs(37, 35).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 3.8F, 1.0F, -0.29007373632884353F, 0.0F, 0.0F));
            PartDefinition ArmLeft = UpperArmLeft.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(46, 35).mirror(true).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 4.0F, 2.0F), PartPose.offset(-0.01F, 3.8F, -2.0F));

            PartDefinition HandLeft = ArmLeft.addOrReplaceChild("HandLeft", CubeListBuilder.create().texOffs(55, 37).mirror(true).addBox(-1.0F, -0.0F, -1.5F, 2.0F, 2.0F, 2.0F), PartPose.offset(-0.1F, 2.9F, 0.8F));

            PartDefinition Neck = Chest.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(31, 17).addBox(-1.5F, -1.0F, -4.4F, 3.0F, 4.0F, 8.0F), PartPose.offsetAndRotation(0.0F, -2.7F, -1.7F, -0.8705702495368991F, 0.0F, 0.0F));
            PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 34).addBox(-2.0F, -2.5F, -2.0F, 4.0F, 5.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 1.8F, -3.5F, 1.0389944824069357F, 0.0F, 0.0F));
            PartDefinition Nose = Head.addOrReplaceChild("Nose", CubeListBuilder.create().texOffs(0, 43).addBox(-1.5F, -1.0F, -3.5F, 3.0F, 2.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 0.7F, -1.2F, 0.1558579075294158F, 0.0F, 0.0F));
            PartDefinition Snout = Nose.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(26, 44).addBox(-1.0F, -1.0F, -3.0F, 2.0F, 2.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -1.7F, 0.2F, 0.5859070245681742F, 0.0F, 0.0F));

            PartDefinition EarLeft = Head.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(0, 29).mirror(true).addBox(-1.0F, -3.0F, 0.0F, 2.0F, 3.0F, 1.0F), PartPose.offsetAndRotation(1.5F, -0.5F, 1.0F, 0.13665927909957545F, -0.6373942508178124F, 0.324631247528848F));

            PartDefinition Mouth = Head.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(15, 45).addBox(-1.0F, -0.5F, -3.3F, 2.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 1.9F, -1.1F, 0.0781907508222411F, 0.0F, 0.0F));

            PartDefinition Horn1Left = Head.addOrReplaceChild("Horn1Left", CubeListBuilder.create().texOffs(46, 52).addBox(0.0F, -4.0F, 0.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.01999998F, 0.0F, 0.01999998F)), PartPose.offsetAndRotation(0.4F, -2.5F, -1.7F, -0.20525072402927477F, -0.017453292519943295F, 0.19198621771937624F));
            PartDefinition Horn2Left = Horn1Left.addOrReplaceChild("Horn2Left", CubeListBuilder.create().texOffs(46, 48).addBox(0.0F, -3.0F, 0.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.00999999F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, -0.19547687289441354F, 0.0F, 0.13962634015954636F));

            PartDefinition Horn3Left = Horn2Left.addOrReplaceChild("Horn3Left", CubeListBuilder.create().texOffs(46, 44).addBox(-0.5F, -3.0F, -1.0F, 1.0F, 3.0F, 1.0F), PartPose.offsetAndRotation(0.5F, -3.0F, 1.0F, 0.3050835452591255F, 0.0F, 0.0F));
            PartDefinition Horn4Left = Horn3Left.addOrReplaceChild("Horn4Left", CubeListBuilder.create().texOffs(46, 41).addBox(-1.0F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F), PartPose.offsetAndRotation(0.5F, -3.0F, 0.0F, 0.11379546689713516F, 0.0F, -0.20943951023931953F));

            PartDefinition EarRight = Head.addOrReplaceChild("EarRight", CubeListBuilder.create().texOffs(0, 29).addBox(-1.0F, -3.0F, 0.0F, 2.0F, 3.0F, 1.0F), PartPose.offsetAndRotation(-1.5F, -0.5F, 1.0F, 0.13665927909957545F, 0.6373942508178124F, -0.324631247528848F));

            PartDefinition Horn1Right = Head.addOrReplaceChild("Horn1Right", CubeListBuilder.create().texOffs(46, 52).mirror(true).addBox(-1.0F, -4.0F, 0.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.01999998F, 0.0F, 0.01999998F)), PartPose.offsetAndRotation(-0.4F, -2.5F, -1.7F, -0.20525072402927477F, 0.017453292519943295F, -0.19198621771937624F));
            PartDefinition Horn2Right = Horn1Right.addOrReplaceChild("Horn2Right", CubeListBuilder.create().texOffs(46, 48).mirror(true).addBox(-1.0F, -3.0F, 0.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.00999999F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, -0.19547687289441354F, 0.0F, -0.13962634015954636F));

            PartDefinition Horn3Right = Horn2Right.addOrReplaceChild("Horn3Right", CubeListBuilder.create().texOffs(46, 44).mirror(true).addBox(-0.5F, -3.0F, -1.0F, 1.0F, 3.0F, 1.0F), PartPose.offsetAndRotation(-0.5F, -3.0F, 1.0F, 0.3050835452591255F, 0.0F, 0.0F));
            PartDefinition Horn4Right = Horn3Right.addOrReplaceChild("Horn4Right", CubeListBuilder.create().texOffs(46, 41).mirror(true).addBox(0.0F, -2.0F, -1.0F, 1.0F, 2.0F, 1.0F), PartPose.offsetAndRotation(-0.5F, -3.0F, 0.0F, 0.11379546689713516F, 0.0F, 0.20943951023931953F));

            PartDefinition ArmBaseRight = Chest.addOrReplaceChild("ArmBaseRight", CubeListBuilder.create().texOffs(22, 34).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(-2.0F, 1.3F, -1.0F, 0.400378539728563F, 0.0F, 0.0F));
            PartDefinition UpperArmRight = ArmBaseRight.addOrReplaceChild("UpperArmRight", CubeListBuilder.create().texOffs(37, 35).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 3.8F, 1.0F, -0.29007373632884353F, 0.0F, 0.0F));

            PartDefinition ArmRight = UpperArmRight.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(46, 35).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 4.0F, 2.0F), PartPose.offset(0.01F, 3.8F, -2.0F));

            PartDefinition HandRight = ArmRight.addOrReplaceChild("HandRight", CubeListBuilder.create().texOffs(55, 37).addBox(-1.0F, -0.0F, -1.5F, 2.0F, 2.0F, 2.0F), PartPose.offset(0.1F, 2.9F, 0.8F));

            PartDefinition Body = Chest.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(20, 0).addBox(-3.0F, -0.5F, -1.0F, 6.0F, 8.0F, 9.0F), PartPose.offsetAndRotation(0.0F, -3.5F, 2.0F, 0.12967796042712246F, 0.0F, 0.0F));
            PartDefinition Hips = Body.addOrReplaceChild("Hips", CubeListBuilder.create().texOffs(0, 13).addBox(-2.5F, -0.5F, 0.0F, 5.0F, 8.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 0.1F, 7.5F, -0.17819811729441132F, 0.0F, 0.0F));
            PartDefinition ThighLeft = Hips.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(0, 49).mirror(true).addBox(-1.5F, -0.5F, -2.0F, 3.0F, 6.0F, 4.0F), PartPose.offsetAndRotation(2.1F, 2.5F, 2.0F, 0.08726646259971647F, 0.0F, 0.0F));

            PartDefinition UpperLegLeft = ThighLeft.addOrReplaceChild("UpperLegLeft", CubeListBuilder.create().texOffs(19, 54).mirror(true).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 4.9F, -0.5F, 0.7143632681676012F, 0.0F, 0.0F));

            PartDefinition LowerLegLeft = UpperLegLeft.addOrReplaceChild("LowerLegLeft", CubeListBuilder.create().texOffs(32, 53).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 6.0F, 2.0F), PartPose.offsetAndRotation(-0.05F, 3.5F, 1.5F, -0.6515314417274163F, 0.0F, 0.0F));
            PartDefinition FootLeft = LowerLegLeft.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(41, 58).mirror(true).addBox(-1.0F, 0.0F, -1.5F, 2.0F, 2.0F, 2.0F), PartPose.offset(-0.1F, 5.3F, -1.4F));

            PartDefinition Tail = Hips.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(41, 2).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 5.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -0.2F, 5.0F, 0.268780698149224F, 0.0F, 0.0F));

            PartDefinition ThighRight = Hips.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(0, 49).addBox(-1.5F, -0.5F, -2.0F, 3.0F, 6.0F, 4.0F), PartPose.offsetAndRotation(-2.1F, 2.5F, 2.0F, 0.08726646259971647F, 0.0F, 0.0F));

            PartDefinition UpperLegRight = ThighRight.addOrReplaceChild("UpperLegRight", CubeListBuilder.create().texOffs(19, 54).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 4.9F, -0.5F, 0.7143632681676012F, 0.0F, 0.0F));
            PartDefinition LowerLegRight = UpperLegRight.addOrReplaceChild("LowerLegRight", CubeListBuilder.create().texOffs(32, 53).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 6.0F, 2.0F), PartPose.offsetAndRotation(0.05F, 3.5F, 1.5F, -0.6511823678875341F, 0.0F, 0.0F));
            PartDefinition FootRight = LowerLegRight.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(41, 58).addBox(-1.0F, 0.0F, -1.5F, 2.0F, 2.0F, 2.0F), PartPose.offset(0.1F, 5.3F, -1.4F));
