...
public abstract class GeladaModel extends ZawaBaseModel<GeladaEntity> {
    ...
    public static class Adult extends GeladaModel {
        ...
        @Override
        public void setupAnim(GeladaEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public static class Child extends GeladaModel {
