...
public abstract class CurassowModel extends ZawaBaseModel<CurassowEntity> {
    ...
    public static class Adult extends CurassowModel {
        ...
        @Override
        public void setupAnim(CurassowEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public static class Child extends CurassowModel {
        public ModelRenderer LegLeft;
        public ModelRenderer LegRight;
        public ModelRenderer Neck;
