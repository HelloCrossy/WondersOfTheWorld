...
public abstract class TakinModel extends ZawaBaseModel<TakinEntity> {
    ...
    public static class Adult extends TakinModel {
        ...
        public Adult() {
            ...
            this.setRotateAngle(UpperLegLeft, 0.6549999427311355F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(ArmRight, -0.10400000254555224F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(ArmLeft, -0.10400000254555224F, 0.0F, 0.0F);
