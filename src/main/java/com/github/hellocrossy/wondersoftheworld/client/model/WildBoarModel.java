...
public abstract class WildBoarModel extends ZawaBaseModel<WildBoarEntity> {
    ...
    public static class Adult extends WildBoarModel {
        ...
        @Override
        public void setupAnim(WildBoarEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public static class Child extends WildBoarModel {
