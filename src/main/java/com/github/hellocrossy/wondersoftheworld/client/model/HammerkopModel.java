...
public abstract class HammerkopModel extends ZawaBaseModel<HammerkopEntity> {
    ...
    public static class Flying extends HammerkopModel {
        ...
        public static LayerDefinition createBodyLayer() {
            MeshDefinition meshDefinition = new MeshDefinition();
            PartDefinition partDefinition = meshDefinition.getRoot();
            PartDefinition Body = partDefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 51).addBox(-2.5F, -2.5F, -3.0F, 5.0F, 5.0F, 8.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 12.8F, -1.0F, -0.10698868514462322F, -0.0F, 0.0F));
            PartDefinition ThighLeft = Body.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(16, 40).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(1.7F, 1.3F, 1.0F, 0.9079202848769335F, 0.0F, 0.0F));
            PartDefinition Leg1Left = ThighLeft.addOrReplaceChild("Leg1Left", CubeListBuilder.create().texOffs(18, 44).addBox(0.0F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(-0.4F, 1.9F, -0.5F, 0.2042035191543852F, 0.0F, 0.0F));
            PartDefinition Leg2Left = Leg1Left.addOrReplaceChild("Leg2Left", CubeListBuilder.create().texOffs(18, 47).addBox(0.0F, 0.0F, -1.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, 1.0F, -0.08237953703228584F, 0.0F, 0.0F));
            PartDefinition FootLeft = Leg2Left.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(25, 56).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.5F, 4.0F, -0.5F, 0.17453292519943295F, 0.0F, 0.0F));
            PartDefinition Toe1L = FootLeft.addOrReplaceChild("Toe1L", CubeListBuilder.create().texOffs(18, 56).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.1F, 0.2F, 0.0F, -0.6710791107076252F, 0.0F));
            PartDefinition Toe2L = FootLeft.addOrReplaceChild("Toe2L", CubeListBuilder.create().texOffs(32, 56).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.1F, 0.2F, 0.0F, 0.6710791107076252F, 0.0F));
            PartDefinition Toe3L = FootLeft.addOrReplaceChild("Toe3L", CubeListBuilder.create().texOffs(20, 52).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

            PartDefinition ThighRight = Body.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(16, 40).mirror(true).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(-1.7F, 1.3F, 1.0F, 0.9079202848769335F, 0.0F, 0.0F));
            PartDefinition Leg1Right = ThighRight.addOrReplaceChild("Leg1Right", CubeListBuilder.create().texOffs(18, 44).mirror(true).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.4F, 1.9F, -0.5F, 0.2042035191543852F, 0.0F, 0.0F));
            PartDefinition Leg2Right = Leg1Right.addOrReplaceChild("Leg2Right", CubeListBuilder.create().texOffs(18, 47).mirror(true).addBox(-1.0F, 0.0F, -1.0F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, 1.0F, -0.08237953703228584F, 0.0F, 0.0F));
            PartDefinition FootRight = Leg2Right.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(25, 56).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(-0.5F, 4.0F, -0.5F, 0.17453292519943295F, 0.0F, 0.0F));
            PartDefinition Toe3R = FootRight.addOrReplaceChild("Toe3R", CubeListBuilder.create().texOffs(20, 52).mirror(true).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
            PartDefinition Toe1R = FootRight.addOrReplaceChild("Toe1R", CubeListBuilder.create().texOffs(32, 56).mirror(true).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.1F, 0.2F, 0.0F, -0.6710791107076252F, 0.0F));
            PartDefinition Toe2R = FootRight.addOrReplaceChild("Toe2R", CubeListBuilder.create().texOffs(18, 56).mirror(true).addBox(-0.5F, -0.5F, -2.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.1F, 0.2F, 0.0F, 0.6710791107076252F, 0.0F));

            PartDefinition Wing1Left = Body.addOrReplaceChild("Wing1Left", CubeListBuilder.create().texOffs(26, 19).addBox(-1.0F, 0.0F, -0.5F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offset(1.5F, -2.3F, -2.0F));
            PartDefinition Wing2Left = Wing1Left.addOrReplaceChild("Wing2Left", CubeListBuilder.create().texOffs(26, 27).addBox(0.0F, -0.5F, -7.0F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(3.0F, 0.5F, 6.5F, 0.0F, 0.18203784630933073F, 0.0F));
            PartDefinition Wing3Left = Wing2Left.addOrReplaceChild("Wing3Left", CubeListBuilder.create().texOffs(27, 35).addBox(0.0F, -0.5F, 0.0F, 3.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(4.0F, 0.0F, -7.0F, 0.0F, -0.0911061832922575F, 0.0F));
            PartDefinition WingTip1L = Wing3Left.addOrReplaceChild("WingTip1L", CubeListBuilder.create().texOffs(29, 43).addBox(-1.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(3.0F, 0.0F, -0.1F, 0.0F, 0.1752310562344404F, 0.0F));
            PartDefinition WingTip2L = WingTip1L.addOrReplaceChild("WingTip2L", CubeListBuilder.create().texOffs(29, 43).addBox(-1.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.1926843487543837F, 0.0F));
            PartDefinition WingTip3L = WingTip2L.addOrReplaceChild("WingTip3L", CubeListBuilder.create().texOffs(29, 43).addBox(-1.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.1926843487543837F, 0.0F));
            PartDefinition WingTip4L = WingTip3L.addOrReplaceChild("WingTip4L", CubeListBuilder.create().texOffs(29, 43).addBox(-1.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.1926843487543837F, 0.0F));
            PartDefinition WingTip5L = WingTip4L.addOrReplaceChild("WingTip5L", CubeListBuilder.create().texOffs(29, 43).addBox(-1.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.1926843487543837F, 0.0F));
            PartDefinition WingTip6L = WingTip5L.addOrReplaceChild("WingTip6L", CubeListBuilder.create().texOffs(29, 43).addBox(-1.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.1926843487543837F, 0.0F));
            PartDefinition WingTip7L = WingTip6L.addOrReplaceChild("WingTip7L", CubeListBuilder.create().texOffs(29, 43).addBox(-1.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.1926843487543837F, 0.0F));

            PartDefinition Wing1Right = Body.addOrReplaceChild("Wing1Right", CubeListBuilder.create().texOffs(26, 19).mirror(true).addBox(-3.0F, 0.0F, -0.5F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offset(-1.5F, -2.3F, -2.0F));
            PartDefinition Wing2Right = Wing1Right.addOrReplaceChild("Wing2Right", CubeListBuilder.create().texOffs(26, 27).mirror(true).addBox(-4.0F, -0.5F, -7.0F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(-3.0F, 0.5F, 6.5F, 0.0F, -0.18203784630933073F, 0.0F));
            PartDefinition Wing3Right = Wing2Right.addOrReplaceChild("Wing3Right", CubeListBuilder.create().texOffs(27, 35).mirror(true).addBox(-3.0F, -0.5F, 0.0F, 3.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(-4.0F, 0.0F, -7.0F, 0.0F, 0.0911061832922575F, 0.0F));
            PartDefinition WingTip1R = Wing3Right.addOrReplaceChild("WingTip1R", CubeListBuilder.create().texOffs(29, 43).mirror(true).addBox(0.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(-3.0F, 0.0F, 0.0F, 0.0F, -0.1752310562344404F, 0.001745329278001762F));
            PartDefinition WingTip2R = WingTip1R.addOrReplaceChild("WingTip2R", CubeListBuilder.create().texOffs(29, 43).mirror(true).addBox(0.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.1926843487543837F, 0.001745329278001762F));
            PartDefinition WingTip3R = WingTip2R.addOrReplaceChild("WingTip3R", CubeListBuilder.create().texOffs(29, 43).mirror(true).addBox(0.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.1926843487543837F, 0.001745329278001762F));
            PartDefinition WingTip4R = WingTip3R.addOrReplaceChild("WingTip4R", CubeListBuilder.create().texOffs(29, 43).mirror(true).addBox(0.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.1926843487543837F, 0.001745329278001762F));
            PartDefinition WingTip5R = WingTip4R.addOrReplaceChild("WingTip5R", CubeListBuilder.create().texOffs(29, 43).mirror(true).addBox(0.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.1926843487543837F, 0.001745329278001762F));
            PartDefinition WingTip6R = WingTip5R.addOrReplaceChild("WingTip6R", CubeListBuilder.create().texOffs(29, 43).mirror(true).addBox(0.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.1926843487543837F, 0.001745329278001762F));
            PartDefinition WingTip7R = WingTip6R.addOrReplaceChild("WingTip7R", CubeListBuilder.create().texOffs(29, 43).mirror(true).addBox(0.0F, -0.5F, 0.0F, 1.0F, 1.0F, 7.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.1926843487543837F, 0.001745329278001762F));

            PartDefinition Chest = Body.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 44).addBox(-2.0F, -3.0F, 0.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 2.5F, -3.0F, 0.8538150381176929F, 0.0F, 0.0F));
            PartDefinition NeckBase = Chest.addOrReplaceChild("NeckBase", CubeListBuilder.create().texOffs(0, 39).addBox(-1.5F, -2.0F, 0.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 0.0F, -0.3673917942290009F, 0.0F, 0.0F));
            PartDefinition Neck = NeckBase.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 35).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, -0.09093165469469484F, 0.0F, 0.0F));
            PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 6).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -2.5F, 0.3F, -0.1429424584146426F, -0.0F, 0.0F));
            PartDefinition Beak = Head.addOrReplaceChild("Beak", CubeListBuilder.create().texOffs(0, 12).addBox(-0.5F, 0.0F, -5.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.1F, 0.1F, 0.1F)), PartPose.offsetAndRotation(0.0F, -1.1F, -1.0F, 0.672300835857699F, 0.0F, 0.0F));
            PartDefinition Mouth = Beak.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(0, 18).addBox(-0.5F, 0.0F, -4.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 1.1F, -0.7F, -0.24382250116413973F, 0.0F, 0.0F));
            PartDefinition BeakTop = Mouth.addOrReplaceChild("BeakTop", CubeListBuilder.create().texOffs(0, 12).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.2F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -1.3F, -0.1F, 0.15411257161951875F, 0.0F, 0.0F));
            PartDefinition Feather1 = Head.addOrReplaceChild("Feather1", CubeListBuilder.create().texOffs(0, 24).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -1.5F, 1.5F, -0.30927233146917027F, 0.0F, 0.0F));
            PartDefinition Feather3 = Head.addOrReplaceChild("Feather3", CubeListBuilder.create().texOffs(0, 32).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, 0.6F, 0.11641346243960232F, 0.0F, 0.0F));
            PartDefinition Feather2 = Head.addOrReplaceChild("Feather2", CubeListBuilder.create().texOffs(0, 28).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.02F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -0.7F, 0.8F, -0.24033184598910243F, 0.0F, 0.0F));
            PartDefinition TailBase = Body.addOrReplaceChild("TailBase", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 4.0F, 2.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -2.1F, 4.8F, 0.0781907508222411F, 0.0F, 0.0F));
            PartDefinition Tail = TailBase.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(14, 0).addBox(-1.5F, -2.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 2.1F, 2.6F, -0.004712389167638204F, 0.0F, 0.0F));
            PartDefinition TailCenter = Tail.addOrReplaceChild("TailCenter", CubeListBuilder.create().texOffs(13, 6).addBox(-1.0F, 0.0F, -0.7F, 2.0F, 1.0F, 5.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offset(0.0F, -1.9F, 2.0F));
            PartDefinition TailFeather1R = TailCenter.addOrReplaceChild("TailFeather1R", CubeListBuilder.create().texOffs(13, 12).mirror(true).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(-0.5F, 0.2F, -2.4F, 0.0F, -0.12810716975954486F, -0.3490658503988659F));
            PartDefinition TailFeather2R = TailFeather1R.addOrReplaceChild("TailFeather2R", CubeListBuilder.create().texOffs(27, 12).mirror(true).addBox(-1.0F, 0.0F, -0.5F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.1F, 0.0F, 0.0F, -0.22724187659914497F, 0.0F));
            PartDefinition TailFeather3R = TailFeather2R.addOrReplaceChild("TailFeather3R", CubeListBuilder.create().texOffs(41, 13).mirror(true).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.1F, 0.0F, 0.0F, -0.24469516911908826F, 0.0F));
            PartDefinition TailFeather4R = TailFeather3R.addOrReplaceChild("TailFeather4R", CubeListBuilder.create().texOffs(52, 12).mirror(true).addBox(-1.0F, 0.0F, -0.4F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.1F, 0.0F, 0.0F, -0.2855358762789167F, 0.0F));
            PartDefinition TailFeather1L = TailCenter.addOrReplaceChild("TailFeather1L", CubeListBuilder.create().texOffs(13, 12).addBox(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.5F, 0.2F, -2.4F, 0.0F, 0.12810716975954486F, 0.3490658503988659F));
            PartDefinition TailFeather2L = TailFeather1L.addOrReplaceChild("TailFeather2L", CubeListBuilder.create().texOffs(27, 12).addBox(0.0F, 0.0F, -0.5F, 1.0F, 1.0F, 6.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.1F, 0.0F, 0.0F, 0.22724187659914497F, 0.0F));
            PartDefinition TailFeather3L = TailFeather2L.addOrReplaceChild("TailFeather3L", CubeListBuilder.create().texOffs(41, 13).addBox(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.1F, 0.0F, 0.0F, 0.24469516911908826F, 0.0F));
            PartDefinition TailFeather4L = TailFeather3L.addOrReplaceChild("TailFeather4L", CubeListBuilder.create().texOffs(52, 12).addBox(0.0F, 0.0F, -0.4F, 1.0F, 1.0F, 5.0F, new CubeDeformation(0.0F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, 0.1F, 0.0F, 0.0F, 0.2855358762789167F, 0.0F));
            return LayerDefinition.create(meshDefinition, 64, 64);
        }
        ...
        public void setupAnim(HammerkopEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            ...
            this.Head.yRot = netHeadYaw / (180F / (float) Math.PI) * 0.25F;
            this.Head.xRot = (headPitch / (180F / (float) Math.PI)) - 0.142F;
            this.Head.zRot = headPitch / (180F / (float) Math.PI) * 0.05F;
        }
        ...
        public void playIdleAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            float speed = 1.0f;
            float degree = 1.0f;
            this.NeckBase.xRot = Mth.cos(2.0F + limbSwing * speed * 0.5F) * limbSwingAmount * (degree * 0.8F) * 0.5F - 0.367F;
            this.Neck.xRot = Mth.cos(2.0F + limbSwing * speed * 0.5F) * limbSwingAmount * (degree * -0.8F) * 0.5F - 0.09F;
            this.Head.xRot = Mth.cos(4.0F + limbSwing * speed * 0.5F) * limbSwingAmount * (degree * -0.2F) * 0.5F - 0.142F;
            this.Body.xRot = Mth.cos(4.0F + limbSwing * speed * 0.5F) * limbSwingAmount * (degree * 0.1F) * 0.5F;
            this.Body.y = Mth.cos(4.0F + limbSwing * speed * 0.5F) * limbSwingAmount * (degree * 5F) * 0.5F + 12.8F;
            this.TailBase.xRot = Mth.cos(5.0F + limbSwing * speed * 0.5F) * limbSwingAmount * (degree * 0.7F) * 0.5F - 0.07F;
