...
public abstract class WhiteTailedDeerModel extends ZawaBaseModel<WhiteTailedDeerEntity> {
    ...
    public static class Adult extends WhiteTailedDeerModel {
        ...
        @Override
        public void setupAnim(WhiteTailedDeerEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public static class Child extends WhiteTailedDeerModel {
