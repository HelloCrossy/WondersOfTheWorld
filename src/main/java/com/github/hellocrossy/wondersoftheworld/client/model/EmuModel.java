...
public abstract class EmuModel extends ZawaBaseModel<EmuEntity> {
    ...
    public static class Adult extends EmuModel {
        ...
        public Adult() {
            ...
            this.NeckBase_1 = new ModelRenderer(this, 26, 48);
            this.NeckBase_1.setPos(0.0F, 1.4F, -4.7F);
            this.NeckBase_1.addBox(-2.0F, -3.0F, -4.5F, 4.0F, 4.0F, 5.0F, -0.02F, 0.0F, 0.0F);
            this.setRotateAngle(NeckBase_1, -0.7819074915776542F, 0.0F, 0.0F);
            this.LegLeft = new ModelRenderer(this, 56, 30);
            this.LegLeft.setPos(0.0F, 3.0F, 0.0F);
            this.LegLeft.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 10.0F, 2.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(LegLeft, -0.350985723228704F, 0.0F, 0.0F);
            this.TailBase = new ModelRenderer(this, 0, 48);
            this.TailBase.setPos(0.0F, 0.3F, 4.0F);
            this.TailBase.addBox(-3.5F, 0.0F, 0.0F, 7.0F, 8.0F, 6.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(TailBase, -0.3127630032889644F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(WingLeft, -0.6646214111173737F, 0.5082398595386212F, 0.0F);
            ...
            this.setRotateAngle(WingRight, -0.6646214111173737F, -0.5082398595386212F, 0.0F);
            this.Head = new ModelRenderer(this, 30, 1);
            this.Head.setPos(0.5F, -6.0F, 1.5F);
            this.Head.addBox(-2.0F, -2.0F, -2.5F, 3.0F, 3.0F, 4.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(Head, 0.19512781569928822F, 0.0F, 0.0F);
            this.FootRight = new ModelRenderer(this, 54, 43);
            this.FootRight.mirror = true;
            this.FootRight.setPos(0.0F, 9.0F, 0.0F);
            ...
            this.setRotateAngle(Body, 0.11699999870255705F, 0.0F, 0.0F);
            this.BeakTip = new ModelRenderer(this, 58, 9);
            this.BeakTip.setPos(0.0F, 0.0F, -1.5F);
            this.BeakTip.addBox(-1.0F, 0.0F, -1.0F, 1.0F, 1.0F, 1.0F, 0.05F, 0.0F, 0.0F);
            ...
            this.setRotateAngle(Toe1Right, 0.0F, 0.27314400463445304F, -0.03490658503988659F);
            ...
            this.ThighRight.addBox(-2.0F, -0.5F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(ThighRight, 0.15600000381832835F, 0.0F, 0.0F);
            ...
            this.Tail.setPos(0.0F, 2.8F, 5.2F);
            this.Tail.addBox(-3.0F, -2.5F, 0.0F, 6.0F, 7.0F, 4.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(Tail, -0.19512781569928822F, 0.0F, 0.0F);
            this.Neck = new ModelRenderer(this, 41, 55);
            ...
            this.UpperBeak.addBox(-1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 2.0F, -0.00999999F, 0.0F, 0.0F);
            this.setRotateAngle(UpperBeak, 0.4363323129985824F, 0.0F, 0.0F);
            this.LegRight = new ModelRenderer(this, 56, 30);
            this.LegRight.mirror = true;
            this.LegRight.setPos(0.0F, 3.0F, 0.0F);
            this.LegRight.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 10.0F, 2.0F, 0.0F, 0.0F, 0.0F);
            ...
            this.Hips.addBox(-4.0F, 0.0F, 0.0F, 8.0F, 9.0F, 4.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(Hips, -0.3909537457888271F, 0.0F, 0.0F);
            this.Beak = new ModelRenderer(this, 55, 5);
            this.Beak.setPos(-0.01F, -0.7F, -2.5F);
            ...
            this.ThighLeft.addBox(-2.0F, -0.5F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(ThighLeft, 0.15600000381832835F, 0.0F, 0.0F);
            this.FootLeft = new ModelRenderer(this, 54, 43);
            this.FootLeft.setPos(0.0F, 9.0F, 0.0F);
            ...
            this.setRotateAngle(Toe2Left, 0.0F, -0.27314400463445304F, 0.03490658503988659F);
        ...
        public void playMovementAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            if (entity.isSprinting()) {
                ...
                this.Body.y = MathHelper.cos(4.5F + limbSwing * speed * 0.4F) * limbSwingAmount * (degree) * 0.5F + 7.2F;
    ...
    public static class Child extends EmuModel {
        ...
        public void playIdleAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            float speed = 1.0f;
            float degree = 1.0f;
            this.NeckBase.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.1F) * limbSwingAmount * (degree * 0.2F) * 0.5F - 0.180F;
            this.Head.xRot = MathHelper.cos(3.0F + limbSwing * speed * 0.1F) * limbSwingAmount * (degree * -0.3F) * 0.5F - 0.110F;
        }
        ...
        public void playMovementAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
                float speed = 1.0f;
                float degree = 1.0f;
                this.NeckBase.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.5F) * limbSwingAmount * (degree * -0.4F) * 0.5F - 0.180F;
                this.Head.xRot = MathHelper.cos(3.0F + limbSwing * speed * 0.5F) * limbSwingAmount * (degree * 0.3F) * 0.5F - 0.110F;
                this.Body.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.5F) * limbSwingAmount * (degree * 0.2F) * 0.5F - 0.136F;
                this.Body.y = MathHelper.cos(4.5F + limbSwing * speed * 0.5F) * limbSwingAmount * (degree) * 0.5F + 16.8F;

                this.ThighLeft.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.25F) * limbSwingAmount * (degree * -2F) * 0.5F + 0.273F;
                this.ThighLeft.y = MathHelper.cos(2.0F + limbSwing * speed * 0.25F) * limbSwingAmount * (degree * 2F) * 0.5F + 0.8F;
                this.LegTopLeft.xRot = MathHelper.cos(0.5F + limbSwing * speed * 0.25F) * limbSwingAmount * (degree * 3F) * 0.5F;
                this.FootLeft.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.25F) * limbSwingAmount * (degree * -2F) * 0.5F + 0.045F;
                this.ThighRight.xRot = MathHelper.cos(1.0F + limbSwing * speed * 0.25F) * limbSwingAmount * (degree * 2F) * 0.5F + 0.273F;
                this.ThighRight.y = MathHelper.cos(2.0F + limbSwing * speed * 0.25F) * limbSwingAmount * (degree * -2F) * 0.5F + 0.8F;
                this.LegTopRight.xRot = MathHelper.cos(0.5F + limbSwing * speed * 0.25F) * limbSwingAmount * (degree * -3F) * 0.5F;
                this.FootRight.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.25F) * limbSwingAmount * (degree * 2F) * 0.5F + 0.045F;
        }
    }
}
