...
public abstract class OryxModel extends ZawaBaseModel<OryxEntity> {
    ...
    public static class Adult extends OryxModel {
        ...
        public Adult() {
            ...
            this.Chest.setPos(0.0F, 4.9F, -6.1F);
            ...
            this.NeckLower.setPos(0.0F, 1.0F, -5.5F);
            ...
            this.Neck.addBox(-2.0F, -7.5F, -3.0F, 4.0F, 9.0F, 6.0F, 0.0F, 0.0F, 0.0F);
            this.setRotateAngle(Neck, 1.656492056983684F, 0.0013962633703865446F, 0.0F);
            ...
            this.Hips.setPos(0.0F, -9.0F, 13.0F);
            ...
            this.Head.setPos(0.0F, -6.0F, 1.0F);
        ...
        //    this.Head.xRot = (headPitch / (180F / (float) Math.PI)) - 0.936F;
        ...
        public void playIdleAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
            float speed = 1.0f;
            float degree = 1.0f;
            this.Neck.xRot = MathHelper.cos(2.0F + limbSwing * speed * 0.07F) * limbSwingAmount * (degree * 0.2F) * 0.5F + 1.656F;
            this.Head.xRot = MathHelper.cos(4.0F + limbSwing * speed * 0.07F) * limbSwingAmount * (degree * -0.15F) * 0.5F - 0.936F;

            this.Tail1.xRot = MathHelper.cos(3.0F + limbSwing * speed * 0.07F) * limbSwingAmount * (degree * -0.3F) * 0.5F + 0.320F;
