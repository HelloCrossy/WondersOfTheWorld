...
public abstract class WolverineModel extends ZawaBaseModel<WolverineEntity> {
    ...
    public static class Adult extends WolverineModel {
        ...
        @Override
        public void setupAnim(WolverineEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    public static class Child extends WolverineModel {
