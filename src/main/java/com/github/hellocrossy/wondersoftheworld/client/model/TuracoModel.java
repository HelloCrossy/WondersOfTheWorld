...
public abstract class TuracoModel extends ZawaBaseModel<TuracoEntity> {
    ...
    public static class Adult extends TuracoModel {
        ...
        protected ZawaModelRenderer cube_r61;
        protected ZawaModelRenderer cube_r62;
        protected ZawaModelRenderer cube_r63;
        protected ZawaModelRenderer cube_r64;
        protected ZawaModelRenderer cube_r65;
        protected ZawaModelRenderer cube_r66;
        protected ZawaModelRenderer cube_r67;
        ...
        public Adult() {
            ...
            MAIN.setPos(0.0F, 15.206F, -9.2594F);
            ...
            cube_r61 = new ZawaModelRenderer(this, 6, 50);
            cube_r61.setPos(0.0F, 0.0F, 0.0F);
            Head.addChild(cube_r61);
            setRotateAngle(cube_r61, 0.5411F, 0.0F, 0.0F);
            cube_r61.addBox(-0.475F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.0F, false);

            cube_r62 = new ZawaModelRenderer(this, 6, 50);
            cube_r62.setPos(0.0F, 0.0F, 0.0F);
            Head.addChild(cube_r62);
            setRotateAngle(cube_r62, 1.021F, 0.0F, 0.0F);
            cube_r62.addBox(-0.525F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.0F, false);

            cube_r63 = new ZawaModelRenderer(this, 6, 50);
            cube_r63.setPos(0.0F, 0.0F, 0.0F);
            Head.addChild(cube_r63);
            setRotateAngle(cube_r63, -1.0428F, 0.0F, 0.0F);
            cube_r63.addBox(-0.475F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.0F, false);

            cube_r64 = new ZawaModelRenderer(this, 6, 50);
            cube_r64.setPos(0.0F, 0.0F, 0.0F);
            Head.addChild(cube_r64);
            setRotateAngle(cube_r64, -0.528F, 0.0F, 0.0F);
            cube_r64.addBox(-0.525F, -2.0F, -0.5F, 1.0F, 2.0F, 1.0F, 0.0F, false);

            cube_r65 = new ZawaModelRenderer(this, 0, 49);
            cube_r65.setPos(0.0F, 1.3862F, -2.011F);
            Head.addChild(cube_r65);
            setRotateAngle(cube_r65, -0.1222F, 0.0F, 0.0F);
            cube_r65.addBox(-0.5F, -0.5362F, -0.839F, 1.0F, 2.0F, 2.0F, 0.0F, false);

            cube_r66 = new ZawaModelRenderer(this, 0, 43);
            cube_r66.setPos(0.0F, 1.3862F, -2.011F);
            Head.addChild(cube_r66);
            setRotateAngle(cube_r66, 0.4887F, 0.0F, 0.0F);
            cube_r66.addBox(-0.25F, -1.0973F, -0.3659F, 1.0F, 1.0F, 2.0F, 0.0F, false);

            cube_r67 = new ZawaModelRenderer(this, 6, 44);
            cube_r67.setPos(0.0F, 0.9554F, -0.4466F);
            Head.addChild(cube_r67);
            setRotateAngle(cube_r67, 0.0087F, 0.0F, 0.0F);
            cube_r67.addBox(-1.5F, -0.975F, -1.075F, 3.0F, 3.0F, 3.0F, 0.0F, false);
