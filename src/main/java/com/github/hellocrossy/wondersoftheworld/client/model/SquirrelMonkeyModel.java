...
public abstract class SquirrelMonkeyModel extends ZawaBaseModel<SquirrelMonkeyEntity> {
    ...
    public static class Adult extends SquirrelMonkeyModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            partDefinition.addOrReplaceChild("LegRight", CubeListBuilder.create().texOffs(51, 42).mirror(true).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 4.0F, -1.0F, 0.4098033003787853F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(16, 53).addBox(-1.0F, 0.0F, -1.5F, 2.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -0.4F, -2.1F, 0.19547687289441354F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(48, 49).mirror(true).addBox(-1.5F, -0.5F, -4.0F, 3.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 4.3F, 2.0F, -0.22078414371937996F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Tail4", CubeListBuilder.create().texOffs(34, 18).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 4.0F, 0.5026548112585615F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail5", CubeListBuilder.create().texOffs(35, 24).addBox(-1.02F, -2.0F, 0.0F, 2.0F, 2.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 4.0F, 0.5026548112585615F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmBaseLeft", CubeListBuilder.create().texOffs(50, 10).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(1.9F, -1.9F, -1.4F, 0.14032447119455382F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(34, 0).addBox(-1.02F, 0.0F, 0.0F, 2.0F, 2.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 6.0F, -1.0110692410066373F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(49, 33).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(2.0F, 2.2F, 4.3F, -0.08726646259971647F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail3", CubeListBuilder.create().texOffs(34, 12).addBox(-1.02F, -2.0F, 0.0F, 2.0F, 2.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 4.0F, 0.5026548112585615F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("LegLeft", CubeListBuilder.create().texOffs(51, 42).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 4.0F, -1.0F, 0.4098033003787853F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Mouth1", CubeListBuilder.create().texOffs(16, 56).addBox(-0.8F, 0.0F, -0.7F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.6F, -0.6F, -0.0911061832922575F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(26, 57).addBox(-0.6F, -1.0F, -0.5F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(1.5F, -0.3F, -1.1F, 0.7037167490777915F, 0.5473352640780661F, 0.0F));
            partDefinition.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(52, 17).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(-0.1F, 3.9F, 1.0F, -0.4098033003787853F, 0.0F, 0.0911061832922575F));
            ...
            partDefinition.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(48, 49).addBox(-1.5F, -0.5F, -4.0F, 3.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 4.3F, 2.0F, -0.22078414371937996F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 52).addBox(-1.5F, -2.0F, -3.0F, 3.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -0.02F, -3.9F, 0.3707079291288539F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmBaseRight", CubeListBuilder.create().texOffs(50, 10).mirror(true).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(-1.9F, -1.9F, -1.5F, 0.14032447119455382F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(52, 17).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(0.1F, 3.9F, 1.0F, -0.4098033003787853F, 0.0F, -0.0911061832922575F));
            ...
            partDefinition.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 33).addBox(-1.5F, -1.5F, -5.0F, 3.0F, 3.0F, 5.0F, new CubeDeformation(-0.1F, 0.0F, 0.0F)), PartPose.offsetAndRotation(0.0F, -1.4F, 0.5F, -0.46914448828868976F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("HandRight", CubeListBuilder.create().texOffs(48, 24).mirror(true).addBox(-1.0F, 0.0F, -3.0F, 2.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 3.3F, -0.4F, 0.0911061832922575F, 0.04555309164612875F, 0.0911061832922575F));
            partDefinition.addOrReplaceChild("TopHead", CubeListBuilder.create().texOffs(26, 54).addBox(-1.0F, -1.0F, -2.0F, 2.0F, 1.0F, 2.0F), PartPose.offset(0.0F, -1.2F, -1.1F));
            partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(2, 2).addBox(-2.5F, -4.0F, -2.5F, 5.0F, 5.0F, 6.0F), PartPose.offsetAndRotation(0.0F, 18.0F, -4.1F, 0.1783726542143524F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 14).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 5.0F, 6.0F), PartPose.offsetAndRotation(0.0F, -4.0F, 3.5F, -0.2724458902442024F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("EarRight", CubeListBuilder.create().texOffs(26, 57).mirror(true).addBox(-0.6F, -1.0F, -0.5F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(-1.5F, -0.3F, -1.1F, 0.7037167490777915F, -0.5473352640780661F, 0.0F));
            partDefinition.addOrReplaceChild("HandLeft", CubeListBuilder.create().texOffs(48, 24).addBox(-1.0F, 0.0F, -3.0F, 2.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 3.3F, -0.4F, 0.0911061832922575F, -0.04555309164612875F, -0.0911061832922575F));
            partDefinition.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(34, 6).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 2.0F, 4.0F, 0.15149458439942998F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(49, 33).mirror(true).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(-2.0F, 2.2F, 4.3F, -0.08726646259971647F, 0.0F, 0.0F));
    ...
    public static class Child extends SquirrelMonkeyModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            partDefinition.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(20, 14).addBox(-0.92F, 0.0F, -1.8F, 2.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(-0.1F, 2.3F, 0.7F, -0.3909537457888271F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail4", CubeListBuilder.create().texOffs(36, 10).addBox(-0.52F, -1.0F, 0.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 2.0F, 0.17697639214433747F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ManeTop", CubeListBuilder.create().texOffs(35, 16).addBox(-1.0F, 0.0F, -3.0F, 2.0F, 1.0F, 3.0F), PartPose.offset(0.0F, -1.7F, 0.8F));
            partDefinition.addOrReplaceChild("LegRight", CubeListBuilder.create().texOffs(21, 9).mirror(true).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(0.1F, 3.8F, -1.3F, 0.45256388036845185F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(20, 14).mirror(true).addBox(-1.08F, 0.0F, -1.8F, 2.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.1F, 2.3F, 0.7F, -0.3909537457888271F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(8, 5).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(-0.12F, 2.9F, 1.0F, -0.2914699983988585F, 0.0F, 0.12217304763960307F));
            ...
            partDefinition.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(35, 0).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 1.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 4.0F, -1.1976449806554086F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("HandRight", CubeListBuilder.create().texOffs(8, 10).mirror(true).addBox(-0.98F, 0.0F, -1.5F, 2.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 2.4F, -1.2F, 0.13823007808953144F, 0.0F, 0.12217304763960307F));
            ...
            partDefinition.addOrReplaceChild("Tail5", CubeListBuilder.create().texOffs(37, 13).addBox(-0.5F, -1.0F, 0.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 2.0F, 0.1378810125720277F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 24).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 18.3F, -1.6F, 0.20821778508924568F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(2, 17).addBox(-1.0F, -1.0F, -3.0F, 2.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, -0.4F, -0.5F, -0.5864306020384839F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(16, 24).addBox(-2.5F, 0.0F, 0.0F, 5.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, -2.0F, 2.0F, -0.16667894689440982F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("LegLeft", CubeListBuilder.create().texOffs(21, 9).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(-0.1F, 3.8F, -1.3F, 0.45256388036845185F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(34, 20).addBox(-1.5F, -1.5F, -2.0F, 3.0F, 3.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 0.5F, -2.6F, 0.42202061845855104F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmBaseLeft", CubeListBuilder.create().texOffs(8, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(1.5F, -0.3F, -0.8F, -0.05794493000107876F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(18, 2).mirror(true).addBox(-1.0F, 0.0F, -1.5F, 2.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(-1.7F, 1.6F, 2.5F, -0.11431906933457996F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("HandLeft", CubeListBuilder.create().texOffs(8, 10).addBox(-1.02F, 0.0F, -1.5F, 2.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 2.4F, -1.2F, 0.13823007808953144F, 0.0F, -0.12217304763960307F));
            ...
            partDefinition.addOrReplaceChild("ArmBaseRight", CubeListBuilder.create().texOffs(8, 0).mirror(true).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(-1.5F, -0.3F, -0.8F, -0.05794493000107876F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(18, 2).addBox(-1.0F, 0.0F, -1.5F, 2.0F, 4.0F, 3.0F), PartPose.offsetAndRotation(1.7F, 1.6F, 2.5F, -0.11431906933457996F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(36, 4).addBox(-0.52F, -1.0F, 0.0F, 1.0F, 1.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 1.0F, 3.0F, 0.2160717633942688F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(8, 5).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(0.12F, 2.9F, 1.0F, -0.2914699983988585F, 0.0F, -0.12217304763960307F));
