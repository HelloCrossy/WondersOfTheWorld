...
public class WOTWEntities {
    ...
    public static final RegistryObject<EntityType<EmuEntity>> EMU =
            REGISTRY.builder(EmuEntity::new, EntityClassification.CREATURE)
                    ...
                    .data(entityBuilder -> entityBuilder.sized(1.1F, 1.45F).clientTrackingRange(10))
                    .build("emu");
    ...
    public static final RegistryObject<EntityType<OscarEntity>> OSCAR =
            REGISTRY.builder(OscarEntity::new, EntityClassification.WATER_AMBIENT)
                    ...
                    .data(tBuilder -> tBuilder.sized(0.3F, 0.3F).clientTrackingRange(4))
                    .build("oscar");
    ...
    public static final RegistryObject<EntityType<MouseDeerEntity>> MOUSE_DEER =
            REGISTRY.builder(MouseDeerEntity::new, EntityClassification.CREATURE)
                    ...
                    .data(entityBuilder -> entityBuilder.sized(0.5F, 0.55F).clientTrackingRange(10))
                    .build("mouse_deer");
    public static final RegistryObject<EntityType<EurasianHoopoeEntity>> EURASIAN_HOOPOE =
            REGISTRY.builder(EurasianHoopoeEntity::new, EntityClassification.CREATURE)
                    .attributes(EurasianHoopoeEntity::registerAttributes)
                    .renderer(() -> EurasianHoopoeRenderer::new)
                    .spawns(15, 3, 5, ZawaSpawnCategory.DRY_GRASSLAND, ZawaSpawnCategory.WET_RAINFOREST)
                    .data(entityBuilder -> entityBuilder.sized(0.45F, 0.55F).clientTrackingRange(8))
    ...
    public static final RegistryObject<EntityType<EurasianHamsterEntity>> EURASIAN_HAMSTER =
            REGISTRY.builder(EurasianHamsterEntity::new, EntityClassification.CREATURE)
                    .attributes(EurasianHamsterEntity::registerAttributes)
                    .renderer(() -> EurasianHamsterRenderer::new)
    ...
    public static final RegistryObject<EntityType<PallasCatEntity>> PALLAS_CAT =
            REGISTRY.builder(PallasCatEntity::new, EntityClassification.CREATURE)
                    ...
                    .data(entityBuilder -> entityBuilder.sized(0.7F, 0.6F).clientTrackingRange(10))
                    .build("pallas_cat");
    ...
    public static final RegistryObject<EntityType<TamarinEntity>> TAMARIN =
            REGISTRY.builder(TamarinEntity::new, EntityClassification.CREATURE)
                    ...
                    .spawns(10, 2, 4, ZawaSpawnCategory.WET_RAINFOREST)
                    .data(entityBuilder -> entityBuilder.sized(0.45F, 0.35F).clientTrackingRange(10))
                    .build("tamarin");
    ...
    public static final RegistryObject<EntityType<SquirrelMonkeyEntity>> SQUIRREL_MONKEY =
            REGISTRY.builder(SquirrelMonkeyEntity::new, EntityClassification.CREATURE)
                    ...
                    .data(entityBuilder -> entityBuilder.sized(0.55F, 0.5F).clientTrackingRange(10))
    ...
    public static final RegistryObject<EntityType<TetraEntity>> TETRA =
            REGISTRY.builder(TetraEntity::new, EntityClassification.WATER_AMBIENT)
                    ...
                    .data(tBuilder -> tBuilder.sized(0.3F, 0.25F).clientTrackingRange(4))
                    .build("tetra");
    ...
    public static final RegistryObject<EntityType<PygmyHippoEntity>> PYGMY_HIPPO =
            REGISTRY.builder(PygmyHippoEntity::new, EntityClassification.CREATURE)
                    ...
                    .data(entityBuilder -> entityBuilder.sized(1.25F, 1.1F).clientTrackingRange(10))
                    .build("pygmy_hippo");
    ...
    public static final RegistryObject<EntityType<HammerkopEntity>> HAMMERKOP =
            REGISTRY.builder(HammerkopEntity::new, EntityClassification.CREATURE)
                    ...
                    .renderer(() -> HammerkopRenderer::new)
                    .spawns(15, 3, 5, ZawaSpawnCategory.DRY_GRASSLAND, ZawaSpawnCategory.WET_RAINFOREST)
                    .data(entityBuilder -> entityBuilder.sized(0.45F, 0.6F).clientTrackingRange(8))
                    .build("hammerkop");
    ...
    public static final RegistryObject<EntityType<HoneyBadgerEntity>> HONEY_BADGER =
            REGISTRY.builder(HoneyBadgerEntity::new, EntityClassification.CREATURE)
                    .attributes(HoneyBadgerEntity::registerAttributes)
                    .renderer(() -> HoneyBadgerRenderer::new)
                    .spawns(8, 1, 1, ZawaSpawnCategory.DRY_SAVANNA)
                    .data(entityBuilder -> entityBuilder.sized(0.85F, 0.65F).clientTrackingRange(10))
                    .build("honey_badger");

    public static final RegistryObject<EntityType<GaboonViperEntity>> GABOON_VIPER =
            REGISTRY.builder(GaboonViperEntity::new, EntityClassification.CREATURE)
                    .attributes(GaboonViperEntity::registerAttributes)
                    .renderer(() -> GaboonViperRenderer::new)
                    .spawns(8, 1, 1, ZawaSpawnCategory.WET_FOREST)
                    .data(entityBuilder -> entityBuilder.sized(1.0F, 0.3F).clientTrackingRange(10))
                    .build("gaboon_viper");

    public static final RegistryObject<EntityType<KirksDikDikEntity>> KIRKS_DIK_DIK =
            REGISTRY.builder(KirksDikDikEntity::new, EntityClassification.CREATURE)
                    .attributes(KirksDikDikEntity::registerAttributes)
                    .renderer(() -> KirksDikDikRenderer::new)
    ...
    public static final RegistryObject<EntityType<AfricanWaterBuffaloEntity>> AFRICAN_WATER_BUFFALO =
            REGISTRY.builder(AfricanWaterBuffaloEntity::new, EntityClassification.CREATURE)
                    .attributes(AfricanWaterBuffaloEntity::registerAttributes)
                    .renderer(() -> AfricanWaterBuffaloRenderer::new)
                    .spawns(10, 3, 5, ZawaSpawnCategory.WET_SAVANNA)
                    .data(entityBuilder -> entityBuilder.sized(1.9F, 1.9F).clientTrackingRange(10))
    ...
    public static final RegistryObject<EntityType<OryxEntity>> ORYX =
            REGISTRY.builder(OryxEntity::new, EntityClassification.CREATURE)
                    ...
                    .data(entityBuilder -> entityBuilder.sized(1.5F, 1.55F).clientTrackingRange(10))
                    .build("oryx");

    public static final RegistryObject<EntityType<SableAntelopeEntity>> SABLE_ANTELOPE =
            REGISTRY.builder(SableAntelopeEntity::new, EntityClassification.CREATURE)
                    .attributes(SableAntelopeEntity::registerAttributes)
                    .renderer(() -> SableAntelopeRenderer::new)
                    .spawns(8, 2, 4, ZawaSpawnCategory.WET_SAVANNA)
                    .data(entityBuilder -> entityBuilder.sized(1.45F, 1.65F).clientTrackingRange(10))
    ...
    public static final RegistryObject<EntityType<SouthernCaracaraEntity>> SOUTHERN_CARACARA =
            REGISTRY.builder(SouthernCaracaraEntity::new, EntityClassification.CREATURE)
                    ...
                    .data(entityBuilder -> entityBuilder.sized(0.6F, 0.65F).clientTrackingRange(8))
    ...
    public static void registerSpawnPlacements() {
        ...
        EntitySpawnPlacementRegistry.register(LOWLAND_NYALA.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(TIBETAN_ANTELOPE.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(SAIGA_ANTELOPE.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(SERVAL.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(EMU.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(KIWI.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(FENNEC_FOX.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(MOUSE_DEER.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(EURASIAN_HOOPOE.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING, ZawaFlyingEntity::checkFlyingSpawnRules);
        EntitySpawnPlacementRegistry.register(MARGAY.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        ...
        EntitySpawnPlacementRegistry.register(EURASIAN_HAMSTER.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        ...
        EntitySpawnPlacementRegistry.register(PALLAS_CAT.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(SLOTH_BEAR.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(MANAKIN.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING, ZawaFlyingEntity::checkFlyingSpawnRules);
        ...
        EntitySpawnPlacementRegistry.register(HONEY_BADGER.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(AFRICAN_WATER_BUFFALO.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(SABLE_ANTELOPE.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        EntitySpawnPlacementRegistry.register(KIRKS_DIK_DIK.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
        ...
        EntitySpawnPlacementRegistry.register(RUFOUS_ELEPHANT_SHREW.get(), EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZawaBaseEntity::checkLandSpawnRules);
