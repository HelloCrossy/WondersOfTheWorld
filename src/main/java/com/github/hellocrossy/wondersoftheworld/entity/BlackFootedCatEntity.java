...
public class BlackFootedCatEntity extends ZawaLandEntity {
    public BlackFootedCatEntity(EntityType<? extends ZawaLandEntity> type, World world) {
        super(type, world);
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld world, AgeableEntity entity) {
        return WOTWEntities.BLACK_FOOTED_CAT.get().create(world);
    }
