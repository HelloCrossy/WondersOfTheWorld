...
public class CurassowEntity extends ZawaLandEntity implements OviparousEntity, SpeciesVariantsEntity {
    public CurassowEntity(EntityType<? extends ZawaLandEntity> type, World world) {
        super(type, world);
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld world, AgeableEntity entity) {
        return WOTWEntities.CURASSOW.get().create(world);
    }
    ...
    public ItemStack getBreedEggItem() {
        return WOTWItems.CURASSOW_EGG.get().getDefaultInstance();
    }
