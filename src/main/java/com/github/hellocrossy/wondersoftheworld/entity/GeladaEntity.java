...
public class GeladaEntity extends ZawaLandEntity implements ClimbingEntity {
    public static final DataParameter<Boolean> CLIMBING;

    public GeladaEntity(EntityType<? extends ZawaLandEntity> type, World world) {
        super(type, world);
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld world, AgeableEntity entity) {
        return WOTWEntities.GELADA.get().create(world);
    }
    ...
    static {
        CLIMBING = EntityDataManager.defineId(GeladaEntity.class, DataSerializers.BOOLEAN);
    }
}
