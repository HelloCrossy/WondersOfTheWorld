...
public class VultureEntity extends ZawaLandEntity implements SpeciesVariantsEntity {
    public VultureEntity(EntityType<? extends ZawaLandEntity> type, World world) {
        super(type, world);
    }
