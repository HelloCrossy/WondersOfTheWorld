...
public class WolverineEntity extends ZawaLandEntity {
    public WolverineEntity(EntityType<? extends ZawaLandEntity> type, World world) {
        super(type, world);
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld world, AgeableEntity entity) {
        return WOTWEntities.WOLVERINE.get().create(world);
    }
