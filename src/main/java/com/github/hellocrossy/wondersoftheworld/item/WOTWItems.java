...
public class WOTWItems {
    ...
    public static final RegistryObject<Item> CURASSOW_EGG = REGISTRAR.register("curassow_egg", () -> new ZawaEggItem(WOTWEntities.CURASSOW, new Item.Properties().stacksTo(16).tab(Zawa.ITEMS_GROUP)));
}
