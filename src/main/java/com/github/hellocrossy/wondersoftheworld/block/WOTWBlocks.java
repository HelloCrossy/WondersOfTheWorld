...
public class WOTWBlocks {
    ...
    public static final RegistryObject<Block> BREEZE_BLOCK_SLAB = registerWithItem("breeze_block_slab", () -> {return new StairsBlock(() -> {return ((Block)BREEZE_BLOCK.get()).defaultBlockState();}, AbstractBlock.Properties.copy((AbstractBlock)BREEZE_BLOCK.get()));});
    ...
    public static final RegistryObject<Block> DEFINED_BREEZE_BLOCK_SLAB = registerWithItem("defined_breeze_block_slab", () -> {return new StairsBlock(() -> {return ((Block)DEFINED_BREEZE_BLOCK.get()).defaultBlockState();}, AbstractBlock.Properties.copy((AbstractBlock)DEFINED_BREEZE_BLOCK.get()));});
    ...
    public static final RegistryObject<Block> RED_BRICK_SLAB = registerWithItem("red_brick_slab", () -> {return new StairsBlock(() -> {return ((Block)RED_BRICK.get()).defaultBlockState();}, AbstractBlock.Properties.copy((AbstractBlock)RED_BRICK.get()));});
